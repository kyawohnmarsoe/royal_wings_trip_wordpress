...
class Zourney_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Zourney Team Box', 'zourney');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'zourney'),
        ...
        $this->add_control(
            'instagram',
            [
                'label'       => esc_html__('Instagram', 'zourney'),
                'placeholder' => esc_html__('https://plus.google.com/u/0/+WPOpal', 'zourney'),
        ...
        $this->add_control(
            'twitter',
            [
                'label'       => esc_html__('Twitter', 'zourney'),
        ...
        $this->add_control(
            'facebook',
            [
                'label'       => esc_html__('Facebook', 'zourney'),
                'placeholder' => esc_html__('https://www.facebook.com/opalwordpress', 'zourney'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => esc_html__('Youtube', 'zourney'),
                'placeholder' => esc_html__('https://www.youtube.com/user/WPOpalTheme', 'zourney'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Hover Color', 'zourney'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'zourney'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute('wrapper', 'class', 'elementor-teams-wrapper zourney-team-box');
                        ...
                        <?php if (!empty($settings[$key])) : ?>
                            <li class="social">
                                <a href="<?php echo esc_url($settings[$key]) ?>">
                                    <i class="zourney-icon-<?php echo esc_attr($social); ?>"></i>
                                </a>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
...
$widgets_manager->register(new Zourney_Elementor_Team_Box());
