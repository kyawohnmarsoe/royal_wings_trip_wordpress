...
/**
 * Class Zourney_Elementor_Blog
 */
class Zourney_Elementor_Post_Grid extends Elementor\Widget_Base {

    public function get_name() {
        return 'zourney-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'zourney');
    }
    ...
    public function get_script_depends() {
        return ['zourney-elementor-posts-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'categories',
            [
                'label'       => esc_html__('Categories', 'zourney'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-style-1' => esc_html__('Style 1', 'zourney'),
                    'post-style-2' => esc_html__('Style 2', 'zourney'),
                    'post-style-3' => esc_html__('Style 3', 'zourney'),
                    'post-style-4' => esc_html__('Style 4', 'zourney'),
                    'post-style-5' => esc_html__('Style 5', 'zourney'),
                ],
        ...
        $this->add_control(
            ...
            [
                'label'      => esc_html__('Style special', 'zourney'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-special-1' => esc_html__('Special 1', 'zourney'),
                    'post-special-2' => esc_html__('Special 2', 'zourney'),
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .elementor-post-wrapper .column-item' => 'padding-left: calc({{SIZE}}{{UNIT}}/2); padding-right: calc({{SIZE}}{{UNIT}}/2);',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'item_spacing_button',
            [
                'label'      => esc_html__('Spacing Button', 'zourney'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
                ...
                'size_units' => ['px', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-post-wrapper .column-item' => 'margin-bottom: calc({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'zourney'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'zourney'),
                    'prev_next'             => esc_html__('Previous/Next', 'zourney'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'zourney') . ' + ' . esc_html__('Previous/Next', 'zourney'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'zourney'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'zourney'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'zourney'),
                'default'   => esc_html__('&laquo; Previous', 'zourney'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'zourney'),
                'default'   => esc_html__('Next &raquo;', 'zourney'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control_carousel(['post_style_special_yes' => '']);
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'zourney') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination"
                 aria-label="<?php esc_attr_e('Pagination', 'zourney'); ?>">
        ...
        ?>>
            ...
            ?>>
                ...
                while ($query->have_posts()) {
                    ...
                    }elseif($style_special == 'post-special-2'){
                        if($count%6 == 0){
                            $style = 'post-style-5';
                        }elseif ($count%6 == 1){
                            $style = 'post-style-1';
...
$widgets_manager->register(new Zourney_Elementor_Post_Grid());
