...
add_action('elementor/element/form/section_field_style/before_section_end', function ($element, $args) {
    ...
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Border Color Focus', 'zourney'),
    ...
    $element->add_control(
        ...
        [
            ...
            'label'     => esc_html__('Textarea', 'zourney'),
            'separator' => 'before'
        ]
    );
    ...
    $element->add_control(
        ...
        [
            'type'      => \Elementor\Controls_Manager::COLOR,
            'label'     => esc_html__('Border Color Active', 'zourney'),
            'selectors' => [
...
add_action('elementor/element/form/section_button_style/before_section_end', function ($element, $args) {
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__('Text Padding', 'zourney'),
