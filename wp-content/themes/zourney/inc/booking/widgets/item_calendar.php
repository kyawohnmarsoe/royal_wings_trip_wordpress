...
class Zourney_BABE_Elementor_Itemcalendar_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Detail Calendar', 'zourney' );
	}
    ...
    protected function title_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Calendar & Prices', 'zourney' ),
                'condition' => [
                    'enable_title' => 'yes',
                ]
            ]
