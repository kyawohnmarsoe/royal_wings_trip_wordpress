 ...
 * @since   1.3.13
 */
class Zourney_BABE_Elementor_RatingFilter_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Rating Filter', 'zourney');
    }
    ...
    public function get_script_depends() {
        return ['zourney-ba-rating-filter.js'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    'style-1' => esc_html__('Vertical', 'zourney'),
                    'style-2' => esc_html__('Horizontal', 'zourney')
                ],
                'default'      => 'style-1',
                'prefix_class' => 'layout-'
            ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Rating Star', 'zourney'),
        ...
        $this->add_responsive_control(
            'rating_size',
            [
                'label'     => esc_html__('Size star', 'zourney'),
        ...
        $this->add_control(
            'rating_color',
            [
                'label'     => esc_html__('Color star', 'zourney'),
        ...
        $this->add_control(
            'rating_color_hover',
            [
                'label'     => esc_html__('Hover color star', 'zourney'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    ...
                    <div class="input-square">
                        ...
                        <label for="rating-filter-<?php echo esc_attr($star); ?>">
                            <span class="rating-stars">
                                <?php
                                printf('%s', $star == 5 ? $star . ' ' . esc_html__('Stars', 'zourney') : $star . ' ' . esc_html__('Stars & Up', 'zourney'));
                                ?>
                            </span>
                        </label>
                    </div>
