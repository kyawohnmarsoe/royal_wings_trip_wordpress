...
class Zourney_BABE_Elementor_Itemduration_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Detail duration', 'zourney');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Duration', 'zourney')
            ]
        );
