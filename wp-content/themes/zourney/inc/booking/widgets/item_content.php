...
class Zourney_BABE_Elementor_Itemcontent_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Detail Content', 'zourney');
    }
    ...
    protected function title_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Description', 'zourney' ),
                'condition' => [
                    'enable_title' => 'yes',
                ]
            ]
    ...
    {
        include get_theme_file_path('template-parts/booking/single/content.php');
    ...
    protected function add_control_style_wrapper($condition = array())
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementor-widget-inner .zourney-single-content',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-widget-inner .zourney-single-content' => 'color: {{VALUE}};',
                ],
            ]
        );
