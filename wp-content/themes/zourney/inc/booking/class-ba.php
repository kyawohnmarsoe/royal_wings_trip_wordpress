...
if (!class_exists('Zourney_BA_Booking')) :
    class Zourney_BA_Booking {

        public static $icons
            = array(
                'dashboard'            => 'zourney-icon-home',
                'profile'              => 'zourney-icon-user',
                'edit-profile'         => 'zourney-icon-edit',
                'company-profile'      => 'zourney-icon-home',
                'edit-company-profile' => 'zourney-icon-edit',
                'change-password'      => 'zourney-icon-unlock',
                'activity'             => 'zourney-icon-home',
                'my-bookings'          => 'zourney-icon-shopping-cart',
                'my-orders'            => 'zourney-icon-shopping-cart',
                'logout'               => 'zourney-icon-sign-out-alt',
                'login'                => 'zourney-icon-sign-in-alt',
                'default'              => 'zourney-icon-random',
                'post_to_book'         => 'zourney-icon-calendar-alt',
                'all-posts-to_book'    => 'zourney-icon-calendar-alt',
                'new-post-to_book'     => 'zourney-icon-plus-circle',
                'post_service'         => 'zourney-icon-home',
                'all-posts-service'    => 'zourney-icon-th-list',
                'new-post-service'     => 'zourney-icon-edit',
                'post_faq'             => 'zourney-icon-home',
                'all-posts-faq'        => 'zourney-icon-th-list',
                'new-post-faq'         => 'zourney-icon-edit',
            );
        ...
        public function babe_add_post_per_page($query) {
            ...
            if ($query->is_main_query() && !empty($object) && ((isset($object->taxonomy) && Zourney_BA_Booking::check_taxonomy($object->taxonomy)) || (isset($object->name) && $object->name == BABE_Post_types::$booking_obj_post_type))) {
        ...
        public function settings_page_taxonomies() {
            add_settings_section(
                ...
                esc_html__( 'Taxonomies Slug', 'zourney' ), // Title
            ...
            foreach ($taxonomies_arr as $slug=>$name){
                ...
                add_settings_field(
                    $slug.'_slug', // ID
                    sprintf( __( '%s slug', 'zourney'), $name), // Title
        ...
        public function booking_calculate_price_customize($output){
            $label = '<label class="booking_form_input_label">'. esc_html__( 'Total', 'zourney' ). '</label>';
            $output = $label .$output;
            return $output;
        }
        ...
        public function setting_ba_fields() {
            ...
            add_settings_field(
                'zourney_booking_google_map_style', // ID
                esc_html__('Select Map Style', 'zourney'), // Title
                array($this, 'google_map_style_callback'), // Callback
                BABE_Settings::$option_menu_slug, // Page
                'setting_section_google',  // Section
                array('option'        => 'zourney_booking_google_map_style',
            ...
            add_settings_field(
                ...
                esc_html__('Select map marker', 'zourney'), // Title
                array($this, 'zourney_google_map_marker'), // Callback
                BABE_Settings::$option_menu_slug, // Page
                'setting_section_google',  // Section
            ...
            add_settings_field(
                'results_per_page', // ID
                esc_html__('Archive Booking: posts per page', 'zourney'), // Title
        ...
        public function sanitize_settings($new_input, $input) {
            $new_input['zourney_booking_google_map_style'] = sanitize_text_field($input['zourney_booking_google_map_style']);
        ...
        public function zourney_google_map_marker($args) {
		...
		public function google_map_style_callback( $args ) {
			$selected_style = isset( BABE_Settings::$settings['zourney_booking_google_map_style'] ) ? BABE_Settings::$settings['zourney_booking_google_map_style'] : 'standard';
			...
			$style_select = $style_select ? '<select id="zourney_booking_google_map_style" name="' . BABE_Settings::$option_name . '[zourney_booking_google_map_style]">' . $style_select . '</select>' : '';
        ...
        public function google_map_style() {
            return $zourney_style_map_arr = [
                'standard'            => esc_html__('Standard', 'zourney'),
                'light_grey_and_blue' => esc_html__('Light Grey and Blue', 'zourney'),
                'ultra_light'         => esc_html__('Ultra Light', 'zourney'),
                'shades_of_grey'      => esc_html__('Shades Of Grey', 'zourney'),
                'blue_water'          => esc_html__('Blue Water', 'zourney'),
                'farma_gray'          => esc_html__('Farma Gray', 'zourney'),
                'community'           => esc_html__('Community', 'zourney'),
                'chilled'             => esc_html__('Chilled', 'zourney'),
            ];
        }
        ...
        public function widgets() {
            ...
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Allitems_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Wishlist_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_TaxonomiesList_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Taxonomies_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_TaxonomyItem_Widget());

            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_Elementor_BA_Archive_Booking());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_Elementor_BA_Archive_Booking_Info());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_Elementor_BA_Archive_Featured_Image());

            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Searchform_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_PriceFilter_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_RatingFilter_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_SeachResults_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_TaxonomyFilter_Widget());

            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Bookingform_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemrelated_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemmaxguests_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemtourtype_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemstars_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemstars_Criteria_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemslideshow_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemcalendar_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemcontent_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemothers_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemaddressmap_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemfaqs_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemaddress_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itempricefrom_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemduration_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemminage_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_ItemTaxonomy_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_ItemIncluded_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Itemsteps_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_BABE_Elementor_Item_Wishlist_Widget());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_Elementor_BA_Archive_Booking_Gallery());
            \Elementor\Plugin::instance()->widgets_manager->register(new Zourney_Elementor_BA_Archive_Booking_Description_Info());
        }
        ...
        public function scripts() {
            ...
            wp_dequeue_style('babe-style');
            wp_register_script('zourney-ba-items', get_theme_file_uri('/assets/js/booking/ba-items.js'), [], $zourney_version);

            // Register Script
            $files = glob(get_theme_file_path('assets/js/booking/*.js'));
            foreach ($files as $file) {
                $filename = wp_basename($file);
                wp_register_script('zourney-ba-' . $filename, get_template_directory_uri() . '/assets/js/booking/' . $filename, ['jquery'], $zourney_version, true);
            }
            ...
            if ($this->check_dashboard() && is_user_logged_in()) {
                ...
                wp_enqueue_script('zourney-nav-mobile', get_template_directory_uri() . '/assets/js/frontend/nav-mobile.js', array('jquery'), $zourney_version, true);
            }
        ...
        public function booking_add_custom_field($cmb) {
            ...
            $cmb->add_field(array(
                'name'     => esc_html__('Video link', 'zourney'),
                'id'       => 'zourney_video_link',
                'type'     => 'oembed',
                'desc'     => sprintf(

                    esc_html__('Enter a youtube, twitter, or instagram URL. Supports services listed at %s.', 'zourney'),
            ...
            $cmb->add_field(
                array(
                    'name' => esc_html__('Feature item', 'zourney'),
                    'id'   => 'zourney_feature_item',
                    'type' => 'checkbox',
                )
            );

            $cmb->add_field(array(
                'name'     => esc_html__('Min Age', 'zourney'),
                'id'       => 'zourney_min_age',
                'type'     => 'text_small',
                'sortable' => true, // beta
            ));
        ...
        public function  booking_update_cateogries($cmb, $prefix){
            ...
            foreach ($all_categories as $category_id => $category_name) {
                ...
                if ($category) {
                    $cmb->add_field(array(
                        'name'       => __('Address', 'zourney'),
                        'id'         => $prefix . 'address_' . $category->slug,
                        'type'       => 'address',
                        'desc'       => __('Street, etc.', 'zourney'),
                        'attributes' => array(
                            'data-conditional-id'    => $prefix . BABE_Post_types::$categories_tax,
                            'data-conditional-value' => $category->slug,
                        ),
                        'before_row' => array(__CLASS__, 'cmb2_before_row_header'),
                        'row_title'  => __('Address section', 'zourney'),
                    ));
                }
            }
        ...
        public function booking_add_include_field($cmb) {
            $prefix               = 'zourney_';
            $included_field_title = esc_html__('Highlights', 'zourney');
            ...
            $included_field_id = $cmb->add_field(array(
                ...
                'options'   => array(
                    ...
                    'add_button'    => sprintf(__('Add %s', 'zourney'), $included_field_title),
                    'remove_button' => sprintf(__('Remove %s', 'zourney'), $included_field_title),
                    'sortable'      => true,
                    // beta
                ),
                'row_title' => $included_field_title,
            ...
            $cmb->add_group_field($included_field_id, array(
                'name' => esc_html__('Title Included', 'zourney'),
                'id'   => $prefix . 'included',
                'type' => 'text_title',
            ));
        }
        ...
        public static function taxonomies_metabox() {
            ...
            if (!empty($taxonomies_arr)) {
                ...
                $cmb_term = new_cmb2_box(array(
                    ...
                    'title'        => esc_html__('Fontawesome Metabox', 'zourney'), // Doesn't output for term boxes
                    'object_types' => array('term'), // Tells CMB2 to use term_meta vs post_meta
                    'taxonomies'   => $taxonomies_arr, // Tells CMB2 which taxonomies should have these fields
                ));

                $cmb_term->add_field(array(
                    'name' => esc_html__('Icon class', 'zourney'),
                    'id'   => 'fa_class',
                    'type' => 'text',
                ));

                $cmb_term->add_field(array(
                    'name' => esc_html__('From', 'zourney'),
                    'id'   => 'fa_from',
                    'type' => 'text',
                ));

                $cmb_term->add_field(array(
                    'name'       => esc_html__('Featured Image', 'zourney'),
                    'id'         => 'zourney_location_image',
                    'type'       => 'file',
                    'query_args' => array(
                        'type' => array(
                            'image/gif',
                ...
                $cmb_term->add_field(array(
                    'name'       => esc_html__('Gallery Image', 'zourney'),
                    'id'         => 'zourney_location_gallery_image',
                    'type'       => 'file_list',
                    'text' => array(
                ...
                $cmb_term->add_field( array(
                    'name' => esc_html__('Description Info', 'zourney' ),
                    'id'   => 'zourney_description_info',
                    'type' => 'textarea_small',
                ) );
                ...
                $group_field_id = $cmb_term->add_field( array(
                    'id'          => 'taxonomy_info',
                    'type'        => 'group',
                    'description' => esc_html__( 'Taxonomy Information', 'zourney' ),
                    'options'     => array(
                        'group_title'       => esc_html__( 'Entry {#}', 'zourney' ), // since version 1.1.4, {#} gets replaced by row number
                        'add_button'        => esc_html__( 'Add Another Entry', 'zourney' ),
                        'remove_button'     => esc_html__( 'Remove Entry', 'zourney' ),
                        'sortable'          => true,
                    ),
                ) );

                $cmb_term->add_group_field( $group_field_id, array(
                    'name' => esc_html__('Entry Title', 'zourney' ),
                    'id'   => 'zourney_title',
                    'type' => 'text',
                ) );

                $cmb_term->add_group_field( $group_field_id, array(
                    'name' => esc_html__('Description', 'zourney' ),
                    'description' => 'Write a short description for this entry',
                    'id'   => 'zourney_description',
                    'type' => 'textarea_small',
                ) );
            }
        }
      ...
      <div class="cmb2-before-row-header"' . $data_id . $data_value . ' name="__row_title_' . $field_args['id'] . '">' . $title . '</div>
        ...
        public static function list_account_menu($check_role) {
            ...
            $output['dashboard'] = esc_html__('Dashboard', 'zourney');

            if ($check_role == 'customer') {
                $output['activity'] = array(
                    'title'       => esc_html__('', 'zourney'),
                    'my-bookings' => esc_html__('My Bookings', 'zourney'),
                );
            }
            ...
            if ($check_role == 'manager') {
                ...
                foreach ($post_type_arr as $post_type) {
                    ...
                    $output['post_' . $post_type] = array(
                        'title'                   => esc_html__('', 'zourney'),
                        'all-posts-' . $post_type => esc_html__('My Tours', 'zourney'),
                        'new-post-' . $post_type  => esc_html__('Add Tour', 'zourney'),
                    );
                }

                $output['activity'] = array(
                    'title'     => esc_html__('', 'zourney'),
                    'my-orders' => esc_html__('My Orders', 'zourney'),
                );
            }

            $output['profile'] = array(
                'title'           => esc_html__('', 'zourney'),
                'edit-profile'    => esc_html__('Edit Profile', 'zourney'),
                'change-password' => esc_html__('Change Password', 'zourney'),
            );

            $output['logout'] = esc_html__('Logout', 'zourney');
    ...
    ';
        ...
        public function add_rating_book_to_option($postID){
		    $options = get_option('zourney_rating_book');
            ...
            update_option('zourney_rating_book', $options);
        }
