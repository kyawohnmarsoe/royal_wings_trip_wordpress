...
if (!class_exists('Zourney_BA_Booking_Reviews')) :
    class Zourney_BA_Booking_Reviews {
        ...
        public function babe_init_rating_criteria() {
            ...
            $rating_criteria_arr['location']  = esc_html__('Location', 'zourney');
            $rating_criteria_arr['amenities'] = esc_html__('Amenities', 'zourney');
            $rating_criteria_arr['services']  = esc_html__('Services', 'zourney');
            $rating_criteria_arr['price']     = esc_html__('Price', 'zourney');
            $rating_criteria_arr['rooms']     = esc_html__('Rooms', 'zourney');
        ...
        public function settings_page_rating_criteria() {
            ...
            add_settings_field(
                'criteria_arr', // ID
                __('Rating Criteria List', 'zourney'), // Title
...
return new Zourney_BA_Booking_Reviews();
