    ...
    <div class="babe_all_items_item_inner">
        ...
        <div class="item_text">
            ...
            <div class="item_head">
                ...
                <a class="read-more-item border-white" href="<?php echo esc_url($item_url); ?>">
                    <span><?php echo esc_html__('More Information', 'zourney'); ?></span><i class="zourney-icon-arrow-long-right"></i>
                </a>
            </div>
