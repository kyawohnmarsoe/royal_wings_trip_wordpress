...
?>
    <form id="checkout_form" name="checkout_form" method="post" action="">
        ...
        <?php Zourney_BA_Booking::load_template_part('checkout/payment', $args); ?>
        ...
        <div class="terms_group">
            <div class="checkout_form_terms_check">
                <div class="input-square">
                    ...
                    <label for="order_terms_check"><?php esc_html_e('I read and agree to the terms & conditions', 'zourney'); ?></label>
                </div>
            </div>
        ...
        <div class="submit_group">
            <button class="btn button checkout_form_submit"><?php esc_html_e('Complete My Order', 'zourney'); ?></button>
        </div>
    </form>
<?php
