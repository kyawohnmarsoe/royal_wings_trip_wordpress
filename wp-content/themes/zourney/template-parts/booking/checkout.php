        ...
        <div class="checkout-wrapper">
            <div class="checkout-inner checkout-row">
                <div id="checkout_form_block" class="checkout-list-item">
                    <h2 class="checkout-title list-order"><?php echo esc_html__('Order #', 'zourney').esc_html($order_num); ?></h2>
                    <?php printf("%s", BABE_html::order_items($order_id)); ?>
                    <?php Zourney_BA_Booking::load_template_part('checkout/coupon', $args); ?>
                </div>
                <div class="checkout-info">
                    <h2 class="checkout-title"><?php esc_html_e('Contact information', 'zourney'); ?></h2>
                    <?php Zourney_BA_Booking::load_template_part('checkout/information', $args); ?>
                </div>
            </div>
        </div>
