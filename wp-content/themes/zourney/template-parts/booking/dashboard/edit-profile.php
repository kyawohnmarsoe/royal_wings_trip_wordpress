...
<div class="my_account_inner_page_block my_account_edit_user_profile">
    <h1 class="page-title"><?php esc_html_e('Edit Profile', 'zourney'); ?></h1>
        ...
        <form id="edit_user_profile" name="edit_user_profile" method="post" action="">
            <div class="edit-profile-inner">
                ...
                <div class="edit-profile-form-block edit-profile-avatar">
                    ...
                    <a class="btn button button_link" href="https://gravatar.com" target="_blank"><?php esc_html_e('Change Picture', 'zourney'); ?></a>
                </div>
                <div class="user_profile_fields_group input_group">
                        ...
                        <div class="checkout-form-block edit-profile-form-block">
                            <div class="checkout_form_input_field <?php echo esc_attr($add_content_class); ?>">
                                ...
                                if($field_name == 'username'){
                                    echo '<label class="checkout_form_input_label">'.esc_html__('User name','zourney').'</label>';
                                }else{
                            ...
                            <?php
                            if($field_name == 'username'){
                                echo '<div class="new-username-check"><span class="new-username-check-msg">' . esc_html__('This username already exists', 'zourney') . '</span></div>';
                            }
                            if($field_name == 'email'){
                                echo '<div class="new-email-check-msg">' . esc_html__('This email already exists', 'zourney') . '</div>';
                            }
                            ?>
                        </div>
                        <?php
                    ...
                    <div class="submit_group">
                        <button class="btn button edit_user_profile_submit"><?php esc_html_e('Update profile', 'zourney'); ?></button>
