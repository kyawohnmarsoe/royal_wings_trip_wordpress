...
///////////////////////////////////////    
    ...
    public static function ajax_get_price_details_block(){
        ...
        foreach($rates as $rate){
            ...
            $rate_to_json = $rate;
            $rate_to_json['date_from'] = BABE_Calendar_functions::date_from_sql( substr($rate['date_from'],0,10) );
            $rate_to_json['date_to'] = BABE_Calendar_functions::date_from_sql( substr($rate['date_to'],0,10) );
